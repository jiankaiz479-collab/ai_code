...
from .views import RemoveBgView, TryCombineView,Reconstruct_3D,SMPLReconstructView
...
urlpatterns = [
    ...
    path('virtual_try_on/fitting/modules', SMPLReconstructView.as_view(), name='SMPLReconstructView'),
]